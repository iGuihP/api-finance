...
const accountPayableRoute = Router();

accountPayableRoute.post("/", async (req, res) => {
...
accountPayableRoute.get("/:date", async (req, res) => {
    const userId = req.user.id;
    const paymentTransactionRepository = new PaymentTransactionRepository();
...
accountPayableRoute.get("/balance/:date", async (req, res) => {
    const userId = req.user.id;
    const paymentTransactionRepository = new PaymentTransactionRepository();
...
accountPayableRoute.delete("/:id", (req, res) => {
    const paymentTransactionRepository = new PaymentTransactionRepository();
...
export default accountPayableRoute;